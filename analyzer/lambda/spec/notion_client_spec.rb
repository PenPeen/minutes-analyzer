    ...
    let(:analysis_result) do
      {
        ...
        'atmosphere' => {
          ...
          'comment' => 'チーム全体が積極的に議論に参加し、特にプロジェクト進捗について建設的な意見交換が行われていました。参加者からの前向きなフィードバックが多く見られる雰囲気でした。'
        },
    ...
    let(:analysis_result) do
      {
        ...
        'atmosphere' => {
          'overall_tone' => 'positive',
          'comment' => 'チーム全体が積極的に議論に参加し、建設的な意見交換が行われていました。参加者からの前向きなフィードバックが多くプロジェクトに対する高いモチベーションが感じられました。'
        },
        'improvement_suggestions' => [
